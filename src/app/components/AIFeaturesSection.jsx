    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="text-center mb-20 relative">
          ...
          <div className={`inline-flex items-center px-4 py-1 rounded-full bg-[rgba(218,165,32,0.05)] border border-[rgba(218,165,32,0.2)] mb-4 transition-all duration-700 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8'
          }`}>
            <span className="text-[#D4AF37] text-sm font-medium">Our Solutions</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          ...
          >
            ...
            >
              ...
              <div className="mb-8 relative z-10">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[rgba(255,175,189,0.2)] to-[rgba(255,175,189,0.05)] flex items-center justify-center border border-[rgba(255,175,189,0.2)] group-hover:border-[rgba(255,175,189,0.3)] transition-all duration-300">
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 3C9.02 3 6.47 5.14 5.9 8H6.9C7.41 5.84 9.53 4.18 12 4.18C14.47 4.18 16.59 5.84 17.1 8H18.1C17.53 5.14 14.98 3 12 3Z" fill="#FF9EB0"/>
                    <path d="M12 19.82C9.28 19.82 7.04 17.62 6.93 14.93C6.92 14.65 6.67 14.43 6.39 14.43H5.91C5.6 14.43 5.35 14.69 5.36 15.01C5.5 18.24 8.42 20.93 12 21C15.59 20.93 18.5 18.24 18.64 15.01C18.65 14.69 18.4 14.43 18.09 14.43H17.61C17.33 14.43 17.08 14.65 17.07 14.93C16.96 17.62 14.72 19.82 12 19.82Z" fill="#FF9EB0"/>
                    <path d="M22 11.5C22 10.12 20.88 9 19.5 9H18.07C17.77 9 17.5 9.31 17.61 9.6C17.72 9.89 17.79 10.2 17.79 10.53C17.79 11.94 16.64 13.08 15.24 13.08H8.76C7.36 13.08 6.21 11.94 6.21 10.53C6.21 10.2 6.28 9.89 6.39 9.6C6.5 9.31 6.23 9 5.93 9H4.5C3.12 9 2 10.12 2 11.5C2 12.88 3.12 14 4.5 14H19.5C20.88 14 22 12.88 22 11.5Z" fill="#FF9EB0"/>
                  </svg>
                </div>
                <div className="w-16 h-1 mx-auto bg-gradient-to-r from-transparent via-[rgba(255,175,189,0.3)] to-transparent my-4 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
              
              <h3 className="text-2xl font-bold mb-4 transition-colors group-hover:text-white">Instant Matching with<br />The Right Creators</h3>
              
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors">
                Our AI examines each creator—video and audio content, audience demographics, engagement metrics, and brand safety—to ensure precise evaluations.
              </p>
              
              {/* Decorative corner element */}
              <div className="absolute top-0 right-0 w-16 h-16 overflow-hidden">
                <div className="absolute top-0 right-0 w-px h-16 bg-gradient-to-b from-[rgba(255,175,189,0.3)] to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="absolute top-0 right-0 h-px w-16 bg-gradient-to-l from-[rgba(255,175,189,0.3)] to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <h3 className="text-2xl font-bold mb-4 transition-colors group-hover:text-white">Automated Collab<br />Management</h3>
              
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors">
                Let Halo AI do the work with a few clicks. Easily launch campaigns, track performance, and give feedback to your creators.
              </p>
          ...
          >
            ...
            >
              {/* Icon with enhanced styling */}
              <div className="mb-8 relative z-10">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[rgba(45,153,255,0.2)] to-[rgba(45,153,255,0.05)] flex items-center justify-center border border-[rgba(45,153,255,0.2)] group-hover:border-[rgba(45,153,255,0.3)] transition-all duration-300">
                  <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5 3C3.89 3 3 3.89 3 5V19C3 20.11 3.89 21 5 21H19C20.11 21 21 20.11 21 19V5C21 3.89 20.11 3 19 3H5Z" fill="#2D3FDE" fillOpacity="0.3"/>
                    <path d="M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3ZM9 17H7V10H9V17ZM13 17H11V7H13V17ZM17 17H15V13H17V17Z" fill="#2D99FF"/>
                    <path d="M14.67 2H9.33C8.6 2 8 2.6 8 3.33V5.67C8 6.4 8.6 7 9.33 7H14.67C15.4 7 16 6.4 16 5.67V3.33C16 2.6 15.4 2 14.67 2Z" fill="#2D99FF"/>
                  </svg>
                </div>
                <div className="w-16 h-1 mx-auto bg-gradient-to-r from-transparent via-[rgba(45,153,255,0.3)] to-transparent my-4 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
              
              <h3 className="text-2xl font-bold mb-4 transition-colors group-hover:text-white">AI Feedback Loop, Not<br />Just Charts</h3>
              
              <p className="text-gray-400 group-hover:text-gray-300 transition-colors">
                Charts are great but you know what's better? A feedback loop that retrains Halo AI to improve all your future campaigns based on the results we deliver for you.
              </p>
              
              {/* Decorative corner element */}
              <div className="absolute top-0 right-0 w-16 h-16 overflow-hidden">
                <div className="absolute top-0 right-0 w-px h-16 bg-gradient-to-b from-[rgba(45,153,255,0.3)] to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="absolute top-0 right-0 h-px w-16 bg-gradient-to-l from-[rgba(45,153,255,0.3)] to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
            </div>
          </div>
        </div>
